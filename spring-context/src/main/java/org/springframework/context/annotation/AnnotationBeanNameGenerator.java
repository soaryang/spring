...
public class AnnotationBeanNameGenerator implements BeanNameGenerator {
	...
	protected String determineBeanNameFromAnnotation(AnnotatedBeanDefinition annotatedDef) {
		...
		//获取AnnotatedBeanDefinition 注解的类型
		Set<String> types = annotationMetadata.getAnnotationTypes();
		String beanName = null;
		for (String type : types) {
			AnnotationAttributes attributes = AnnotationConfigUtils.attributesFor(annotationMetadata, type);
			Set<String> metaAnnotationTypes = annotationMetadata.getMetaAnnotationTypes(type);
			//org.springframework.stereotype.Component 注解的判断
			boolean isStereotypeWithNameValue = isStereotypeWithNameValue(type, metaAnnotationTypes, attributes);
			if (attributes != null && isStereotypeWithNameValue) {
